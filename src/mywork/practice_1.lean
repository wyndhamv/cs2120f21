...
The introduction rule is that you assume you have an arbitrary object of a type.
Then, you prove that the proposition is true for that arbitrary object. Because 
you did not describe a specific object, it must be true for all objects of that type.
-/
